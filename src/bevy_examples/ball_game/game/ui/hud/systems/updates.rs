use crate::bevy_examples::ball_game::game::enemy::components::Enemy;
use bevy::prelude::*;

use crate::bevy_examples::ball_game::game::score::resources::Score;
use crate::bevy_examples::ball_game::game::ui::hud::components::{EnemyText, ScoreText};
